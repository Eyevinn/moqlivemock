...
mlmpub mlmsub:
	go build -ldflags "-X github.com/Eyevinn/moqlivemock/internal.commitVersion=$$(git describe --tags HEAD) -X github.com/Eyevinn/moqlivemock/internal.commitDate=$$(git log -1 --format=%ct)" -o out/$@ ./cmd/$@/main.go
