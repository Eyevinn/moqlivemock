...
var (
	commitVersion string = "0.4.0"      // Should be updated during build
	commitDate    string = "1736438400" // commitDate in Epoch seconds (can be filled/updated in during build)
)
