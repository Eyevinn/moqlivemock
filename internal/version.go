...
var (
	commitVersion string = "0.15.0"     // Should be updated during build
	commitDate    string = "1789552800" // commitDate in Epoch seconds (can be filled/updated in during build)
)
