...
var (
	commitVersion string = "0.1.0"      // Should be updated during build
	commitDate    string = "1744726710" // commitDate in Epoch seconds (can be filled/updated in during build)
)
