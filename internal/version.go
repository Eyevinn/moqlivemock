...
var (
	commitVersion string = "0.15.1"     // Should be updated during build
	commitDate    string = "1789984800" // commitDate in Epoch seconds (can be filled/updated in during build)
)
